...
--[[
Sources:
    https://github.com/opencv/opencv/blob/4.10.0/samples/python/tutorial_code/imgProc/threshold/threshold.py
--]]
...
local parser = argparse() {description='Code for Basic Thresholding Operations tutorial.'}
