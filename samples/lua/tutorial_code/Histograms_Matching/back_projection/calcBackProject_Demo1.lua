...
--[[
Sources:
    https://github.com/opencv/opencv/blob/4.8.0/samples/lua/tutorial_code/Histograms_Matching/back_projection/calcBackProject_Demo1.py
--]]
...
local ch = {0, 0}
hue = cv.Mat.zeros(hsv.rows, hsv.cols, cv.CV_MAKETYPE(hsv:depth(), hsv:channels()))
