...
--[[
Sources:
    https://github.com/opencv/opencv/blob/4.10.0/samples/python/tutorial_code/video/meanshift/camshift.py
--]]
...
local parser = argparse() {description='This sample demonstrates the camshift algorithm. \
...
while true do
    ...
    -- Draw it on image
    local pts = cv.boxPoints(ret):convertTo(cv.CV_32S)
    local img2 = cv.polylines(frame, { pts }, true, 255, 2)
    cv.imshow('img2', img2)
